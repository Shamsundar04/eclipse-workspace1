package jdbc.schema;
//Test09_Stmt_RSMD_ColumsInfo.java
...
public class Test09_Stmt_RSMD_ColumsInfo {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		System.out.println("\ncolumn1 size: " + rsmd.getColumnDisplaySize(1) + ", " + rsmd.getPrecision(1) + ", "
				+ rsmd.getScale(1));
		System.out.println("column2 size: " + rsmd.getColumnDisplaySize(2) + ", " + rsmd.getPrecision(2) + ", "
				+ rsmd.getScale(2));
		System.out.println("column3 size: " + rsmd.getColumnDisplaySize(3) + ", " + rsmd.getPrecision(3) + ", "
				+ rsmd.getScale(3));
