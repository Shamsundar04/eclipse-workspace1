...
//class ExceptionDemo{
//	public static void main(String[] args) {
//		methodA();		// Un-handled exception type Exception 
//	}
//
//	public static void methodA() throws Exception {
...
//	}
//}
//If method throwing the error before calling means throw Exception then caller
...
//just exit from the method immediately
//return; in a void method → exit the method immediately, no value returned.
//Optional at the end of a method.
...
//	The reason you may think "finally is not executed" is because your original code does not even compile
//	(because of unreachable code after the first throw).
//	So if you’re running the raw version, the compiler won’t let you execute, meaning you’ll never reach finally.
//---------------------------------------------------------------------
